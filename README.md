...
Polymarket Bitcoin Micro Cycle clicking automat - Tampermonkey userscript pro monitoring a automaticke obchodovani na Polymarket BTC Up/Down 5-minutovych trzich.
...
- Simuluje nebo provadi nakupy podle pravidel (SIM/LIVE mod)
...
- Scraping cash balance z Polymarket nav baru
- Profit killswitch - automaticke vypnuti pri velke ztrate
- Cash safety - blokuje LIVE nakupy pri nizkem zustatku
...
Vyvinuto Agent Zero headless, bez lidske supervize - pouze na zaklade pocatecnich instrukci a pristupu.
